...
//		CurrentNote.set(null);
    ...
    private Day getDay(CalendarDate date) {
        ...
        /*
         * if (y == null) return null; if (m == null) return null;
         */
    ...
    private class Year {
        ...
        public Month getMonth(int m) {
            ...
            // TASK 2-2 SMELL BETWEEN CLASSES
            // CODE SMELL - Not exactly feature envy or Excessive Use of Literals (kind of
            // inbetwee I suppose), but getMonth is used for the ui and behind the scenes
            // and setting it instantly to null isn't a good thing to do.
    ...
    private class Month {
        ...
        public Day getDay(int d) {
            ...
            // TASK 2-2 SMELL BETWEEN CLASSES
            // CODE SMELL IS DESCRIBED IN getMonth method
            return createDay(d);
            // return null;
        }
